...
export function getHeader(atomicArbDetails) {
...
export function getTxLinkLine(atomicArbDetails) {
...
export function getProfitRevCostLine(atomicArbDetails) {
    let margin;
...
export function getPositionGasBribeLine(atomicArbDetails) {
    var _a;
...
export function getValidatorLine(atomicArbDetails) {
...
export async function buildNetWinAndBribeMessage(atomicArbDetails) {
    if (!atomicArbDetails.blockBuilder)
        return null;
...
export async function buildNetWinButNoBribeMessage(atomicArbDetails) {
    const txLinkLine = getTxLinkLine(atomicArbDetails);
    return `${txLinkLine}`;
}
